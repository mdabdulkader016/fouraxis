      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          <div className="relative inline-flex items-center gap-3 px-6 py-2.5 rounded-2xl border border-white/[0.08] bg-[#0b0514] text-[16px] font-light text-white mb-8 overflow-hidden shadow-xl z-10">
            ...
            <span className="tracking-tight relative z-10 text-white">Review</span>
          </div>
          <motion.h2
            ...
            className="text-4xl md:text-[3.5rem] font-display font-medium leading-[1.1] tracking-tight text-white max-w-4xl"
          >
            <span className="text-white block">What our clients</span>
            <span className="text-white/40 block">are saying</span>
          </motion.h2>
        </div>
