...
import { MapPin, Rocket, ChevronUp } from "lucide-react";
  ...
  return (
    <footer className="bg-[#0b0514] pt-8 pb-0 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 max-w-[1400px]">
        ...
        <div className="relative w-full rounded-t-[3.5rem] md:rounded-t-[4.5rem] rounded-b-none border border-white/10 bg-[#000000] overflow-hidden p-12 md:p-20 md:pb-20 shadow-2xl">
